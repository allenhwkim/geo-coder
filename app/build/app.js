...
var bing_1 = __webpack_require__(12);
var google_1 = __webpack_require__(13);
var open_street_1 = __webpack_require__(14);
...
var provider = {
    ...
    OpenStreet: open_street_1.OpenStreet
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var geo_coder_1 = __webpack_require__(11);
...
var GeoCoder = (function () {
    function GeoCoder(options) {
        ...
        switch (this.options.provider.toLowerCase()) {
            case 'osm':
                this.provider = new index_1.provider.OpenStreet(options);
                break;
            case 'bing':
                this.provider = new index_1.provider.Bing(options);
                break;
            case 'google':
                this.provider = new index_1.provider.Google(options);
                break;
        }
    }
    ...
    GeoCoder.prototype.autocomplete = function (inputEl) {
        ...
        inputEl.addEventListener('keyup', function (event) {
            ...
            _this.geocode(event.target.value).then(function (result) {
...
var Bing = (function () {
    ...
    Bing.prototype.geolookup = function (address) {
        ...
        url = url + "?" + index_1.serialize(params);
    ...
    Bing.prototype.reverse = function (lat, lon) {
        var url = "http://dev.virtualearth.net/REST/v1/Locations/" + lat + "," + lon;
        var params = {
            includeNeighborhood: this.options.includeNeighborhood || 0,
            key: this.options.key
        };
 ...
 * @class Google
 */
var name = ['point_of_interest', 'establishment', 'natural_feature', 'airport'];
var road = ['street_address', 'route', 'sublocality_level_5', 'intersection'];
...
var Google = (function () {
    ...
    Google.prototype.geolookup = function (address) {
        var _this = this;
        ...
        return fetch(url)
            ...
            .then(function (json) { return _this._handleResponse(json); });
    };
    Google.prototype.reverse = function (lat, lon) {
        var url = 'https://maps.googleapis.com/maps/api/geocode/json';
        var params = {
            latlng: lat + "," + lon,
            key: this.options.key,
        ...
        return fetch(url + "?" + index_1.serialize(params))
            .then(function (resp) { return resp.json(); })
            .then(function (json) {
            return {
                source: 'Google',
    ...
    Google.prototype._handleResponse = function (json) {
        ...
        if (results) {
            ...
            results.forEach(function (result) {
                var details = getDetails_1(result.address_components);
...
var OpenStreet = (function () {
    ...
    OpenStreet.prototype.geolookup = function (address) {
    ...
    OpenStreet.prototype.reverse = function (lat, lon) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var geocoder_1 = __webpack_require__(1);
...
var Main = (function () {
    function Main() {
        ...
        var selectEl = document.querySelector('#provider');
        this.setProvider(selectEl['value']);
        selectEl.addEventListener('change', function (e) { return _this.setProvider(e.target['value']); });
    }
    Main.prototype.setProvider = function (providerName) {
        if (providerName === void 0) { providerName = 'osm'; }
        var geoCoderOptions = { provider: providerName };
    ...
    Main.prototype.geocode = function () {
        var _this = this;
        var inputEl = document.querySelector('#geocode .address');
        var resultEl = document.querySelector('#geocode .result');
        inputEl.addEventListener('change', function (event) {
            var address = event.target.value;
            _this.geoCoder.geocode(address).then(function (result) {
    ...
    Main.prototype.autocomplete = function () {
        var inputEl = document.querySelector('#autocomplete .address');
        this.geoCoder.autocomplete(inputEl);
        var resultEl = document.querySelector('#autocomplete .result');
        inputEl.addEventListener('place_changed', function (event) {
            resultEl.value = JSON.stringify(event.detail, null, '  ');
        });
    };
    Main.prototype.reverseLookup = function () {
        var _this = this;
        var latEl = document.querySelector('#reverse .lat');
        var lonEl = document.querySelector('#reverse .lon');
        var resultEl = document.querySelector('#reverse .result');
        var reverseHandler = function (event) {
            var lat = parseFloat(latEl.value || '0');
            var lon = parseFloat(lonEl.value || '0');
            _this.geoCoder.reverse(lat, lon).then(function (result) {
                resultEl.value = JSON.stringify(result, null, '  ');
            });
        };
